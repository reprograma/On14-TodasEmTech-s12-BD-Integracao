//requerindo a sua schema  da model
const MusicaSchema = require('../model/musicaschema')

//requerindo  o mongoo
const mongoose = require('mongoose')

//função do getAll para trazer a lista  completa  
const getAll = async (req, res) => {// fazer  a função async para que ela espere  suas funcionalidades 
 try {
...
// procura por id 
const msicaPorId = async (req, res) => {
  try {
    const  musicaEncontrada = await
    MusicaSchema.findById(req.params.id)
